...
I am back from **[GUADEC 2024](#guadec_2024_in_Denver)** in Denver and did not only give a talk about Snap but learned about the efforts towards **[flatpaking daemons](#flatpaking daemons)** and methods of analysing graphical results in CI testing.
...
Did you know that humans have even printed in space? The [Space Shuttles had a 59-pound-weighing 80-column line printer on board](http://www.righto.com/2024/08/space-shuttle-interim-teleprinter.html). See also the comments, where it is told that the line printers got later on replaced by stock [Espon Stylus Color 900](https://catalog.archives.gov/id/23495117) inkjet printers.
