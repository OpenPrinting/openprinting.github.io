...
**Souptik De, who did the [Winter of Code](https://www.linkedin.com/company/winter-of-code/) project of adding CI workflows to the [CPDB backend for CUPS](https://github.com/OpenPrinting/cpdb-libs/) voluntarily did several improvements on CPDB following the needs of Ayush for the COSMIC dialog and also following the discussion for the XDG Desktop Portal improvements. Thanks a lot to him.**
