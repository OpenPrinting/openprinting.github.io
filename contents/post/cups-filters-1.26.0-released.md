...
author: Till
excerpt: >-
  Feature release, cups-browsed and driverless utility use
  DNS-SD-service-name-based URIs for IPP print queues now, like CUPS does.
  cups-browsed handles print jobs to clusters now while it is still creating
  local print queues. A lot of bug fixes on cups-browsed and the driverless
  utility
date: '2019-12-13'
---
